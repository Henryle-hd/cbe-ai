...
import ListOfInfoTitleFetch from "@/components/listOfCbeInfoTitleFetch";
  ...
  return (
    <Card className="no-scrollbar sticky left-0 top-0 flex max-h-[100vh] min-h-screen  w-full flex-col justify-start gap-2 overflow-y-auto rounded-l-none rounded-r-sm bg-[#f0f0f0] px-1 dark:bg-background">
      <CardContent className="flex flex-col justify-start gap-4">
        <div className="relative left-2 top-0 my-3 flex items-center justify-start gap-3">
          <Avatar className="p-1">
            <AvatarImage src="https://cosis.cbe.ac.tz//assets/themes/logo.png" />
            <AvatarFallback className="font-bold text-cbeaiclr-1">
              CBE
            </AvatarFallback>
          </Avatar>
       ...
       {/* {isAdmnPage && <ListOfInfoTitleFetch />} */}
        <Separator />
        <p className="text-center text-[12px] text-opacity-50">
          Copyright © 2024
        </p>
